...
let
  colors = config.colorsScheme.colors;
in
{

  home.file = {
    ".config/bat/themes/nix_colors.tmTheme" = {
      text = ''
        		...
        		<array>
        			<dict>
        				...
        				<dict>
        					...
        					<key>selection</key>
        					<string>#${colors.base08}40</string>
        					<key>selectionBorder</key>
        					<string>#${colors.base08}</string>
        					<key>shadow</key>
        					<string>#00000010</string>
        					<key>stackGuide</key>
        					<string>#${colors.base02}60</string>
        					<key>tagsOptions</key>
